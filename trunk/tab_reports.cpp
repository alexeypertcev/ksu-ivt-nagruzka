...
bool create_report_xlsx(QList<Tabledata> list_tabledata, QString template_patch, QString report_patch)
{
    ...
    for (int i=0; i<list_tabledata.length(); ++i){
        ...
        sheet1[ 5 ][ 1 ] = temp_tabledata.get_FIO().toStdString();
        sheet1[ 5 ][ 1 ] = cellformat_header4;
        sheet1[ 6 ][ 1 ] = temp_tabledata.get_degre_and_status().toStdString();
        sheet1[ 6 ][ 1 ] = cellformat_header4;
        sheet1[ 7 ][ 1 ] = temp_tabledata.get_kaf_faculty().toStdString();
        sheet1[ 7 ][ 1 ] = cellformat_header4;
        sheet1[ 8 ][ 6 ] = temp_tabledata.get_obiem().toStdString();
        sheet1[ 8 ][ 6 ] = cellformat_header4;

        sheet1[ 10 ][ 0 ] = "Наименование учебной дисциплины или учебных поручений";
        sheet1[ 10 ][ 0 ] = cellformat_header5;
        sheet1[ 11 ][ 0 ] = " ";

        sheet1[ 10 ][ 1 ] = "Факультет";
        sheet1[ 10 ][ 1 ] = cellformat_header6;
        sheet1[ 10 ][ 2 ] = "Специальность";
        sheet1[ 10 ][ 2 ] = cellformat_header6;
        sheet1[ 10 ][ 3 ] = "Форма обучения";
        sheet1[ 10 ][ 3 ] = cellformat_header6;
        sheet1[ 10 ][ 4 ] = "Курс";
        sheet1[ 10 ][ 4 ] = cellformat_header6;
        sheet1[ 10 ][ 5 ] = "Количество групп";
        sheet1[ 10 ][ 5 ] = cellformat_header6;
        sheet1[ 10 ][ 6 ] = "Количество подгрупп";
        sheet1[ 10 ][ 6 ] = cellformat_header6;
        sheet1[ 10 ][ 7 ] = "Количество студентов";
        sheet1[ 10 ][ 7 ] = cellformat_header6;

        sheet1[ 10 ][ 8 ] = "По учебному плану";
        sheet1[ 10 ][ 8 ] = cellformat_header0;

        sheet1[ 11 ][ 8 ] = "Лекции";
        sheet1[ 11 ][ 8 ] = cellformat_header6;
        sheet1[ 11 ][ 9 ] = "Семинары и практич. Работы";
        sheet1[ 11 ][ 9 ] = cellformat_header6_wrap;
        sheet1[ 11 ][ 10 ] = "Лабораторные работы";
        sheet1[ 11 ][ 10 ] = cellformat_header6_wrap;

        sheet1[ 10 ][ 11 ] = "Рук-во сам. Раб";
        sheet1[ 10 ][ 11 ] = cellformat_header0_wrap;

        sheet1[ 11 ][ 11 ] = "индивидуальная";
        sheet1[ 11 ][ 11 ] = cellformat_header6;
        sheet1[ 11 ][ 12 ] = "аудиторная";
        sheet1[ 11 ][ 12 ] = cellformat_header6;

        sheet1[ 10 ][ 13 ] = "Контрольные работы";
        sheet1[ 10 ][ 13 ] = cellformat_header6;
        sheet1[ 10 ][ 14 ] = "Консультации";
        sheet1[ 10 ][ 14 ] = cellformat_header6;
        sheet1[ 10 ][ 15 ] = "Зачеты";
        sheet1[ 10 ][ 15 ] = cellformat_header6;
        sheet1[ 10 ][ 16 ] = "Экзамены";
        sheet1[ 10 ][ 16 ] = cellformat_header6;
        sheet1[ 10 ][ 17 ] = "Курсовые работы";
        sheet1[ 10 ][ 17 ] = cellformat_header6;
        sheet1[ 10 ][ 18 ] = "Дипломные работы";
        sheet1[ 10 ][ 18 ] = cellformat_header6;
        sheet1[ 10 ][ 19 ] = "Практика";
        sheet1[ 10 ][ 19 ] = cellformat_header6;
        sheet1[ 10 ][ 20 ] = "ГАК";
        sheet1[ 10 ][ 20 ] = cellformat_header6;

        sheet1[ 10 ][ 21 ] = "Прочие виды работ";
        sheet1[ 10 ][ 21 ] = cellformat_header0;

        sheet1[ 10 ][ 24 ] = "Итого";
        sheet1[ 10 ][ 24 ] = cellformat_header6;
        sheet1[ 10 ][ 25 ] = "Примечания";
        sheet1[ 10 ][ 25 ] = cellformat_header6;
